    ...
    return (
        <GuestLayout>
            ...
            <div className="flex justify-center items-center">
                <a href="login/redirect" type="submit" className="bg-battlenet transition border-2 border-battlenet hover:border-battlenet-light w-full rounded-full flex items-center justify-center text-white px-5 py-2">
                    Logg inn med
                    <svg className="ml-4 mr-2 h-[24px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            {/*<form onSubmit={submit}>
                ...
                <div className="flex mt-4">
                    <button type="submit"
                            className="w-full text-white bg-gradient-to-br from-green-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2"
                            disabled={processing}>
                        Login
                    </button>
                </div>
                ...
                <div className="flex mt-4">
                    <Link
                        href={route('register')}
                        className="w-full text-white bg-gradient-to-r from-cyan-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"
                    >
                        Register
                    </Link>
                </div>
